...
pkg_build_deps=(core/make core/gcc core/patch core/local-lib core/cpanminus core/expat)
pkg_lib_dirs=(lib)
pkg_bin_dirs=(bin)
...
do_prepare() {
  ...
  LD_LIBRARY_PATH="$(pkg_path_for core/expat)/lib:${LD_LIBRARY_PATH}"
  export LD_LIBRARY_PATH
  EXPATLIBPATH=$(pkg_path_for core/expat)/lib
  export EXPATLIBPATH
  EXPATINCPATH=$(pkg_path_for core/expat)/include
  export EXPATINCPATH
